...
import com.hemaapp.dtyw.db.SysInfoDBHelper;
import com.hemaapp.dtyw.db.UserDBHelper;
 ...
 */
public class DtywApplication extends HemaApplication {

    private static final String TAG = DtywApplication.class.getSimpleName();
    private SysInitInfo sysInitInfo;
    private User user;
    private CitySan cityInfo;
    private static DtywApplication application;
    private Select select;
    public static DtywApplication getInstance() {
        return application;
    }
    ...
    public void onCreate() {
        application = this;
        XtomConfig.LOG = DtywConfig.DEBUG;
        HemaConfig.UMENG_ENABLE = DtywConfig.UMENG_ENABLE;
        ...
        XtomConfig.DATAKEY = "DSZtGBc4WkJ0flId";
