...
import com.hemaapp.dtyw.adapter.BuyCarActivityAdapter;
 ...
 * 购物车activity
 */
public class BuyCarActivity extends DtywActivity {
    ...
    private BuyCarActivityAdapter adapter;
    ...
    private void freshData() {
        if (adapter == null) {
            adapter = new BuyCarActivityAdapter(mContext, BuyCarActivity.this, cars);
    ...
    protected void setListener() {
        ...
        buy_text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(BuyCarActivity.this, AffirmActivity.class);
