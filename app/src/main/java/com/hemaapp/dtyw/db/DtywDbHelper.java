 ...
 */
public class DtywDbHelper extends SQLiteOpenHelper {

    private static final String DBNAME = "dtyw.db";
    ...
    public DtywDbHelper(Context context) {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(userSQL);
        String citys = "id text,name text,parentid text,nodepath text,namepath text,charindex text,level text,orderby text";
