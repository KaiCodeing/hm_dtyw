...
import com.hemaapp.dtyw.activity.BuyCarActivity;
 ...
 */
public class BuyCarActivityAdapter extends HemaAdapter {
    private BuyCarActivity fragment;
    private ArrayList<Car> cars;

    public BuyCarActivityAdapter(Context mContext, BuyCarActivity fragment, ArrayList<Car> cars) {
        super(mContext);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(fragment).inflate(R.layout.item_buy_car_view, null);
    ...
    private void setView(ViewHolder holder, int position) {
        ...
        holder.layout1_in.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Car car1 = (Car) v.getTag(R.id.TAG);
                Intent intent = new Intent(fragment, CommodityInforActivity.class);
