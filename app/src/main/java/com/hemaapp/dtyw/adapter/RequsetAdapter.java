 ...
 */
public class RequsetAdapter extends HemaAdapter {
    private IssueDemandActivity mContext;
    ...
    public RequsetAdapter(IssueDemandActivity mContext, ArrayList<String> imgs, View view) {
        super(mContext);
