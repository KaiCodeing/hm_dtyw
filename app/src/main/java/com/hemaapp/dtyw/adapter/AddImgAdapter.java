...
import com.hemaapp.dtyw.activity.CommodityEvaluateActivity;
 ...
 *
 */
public class AddImgAdapter extends HemaAdapter {
	private CommodityEvaluateActivity mContext;
...
//	private viewHolder holder;
	...
	public AddImgAdapter(CommodityEvaluateActivity mContext,ArrayList<String> imgs, View view) {
		super(mContext);
