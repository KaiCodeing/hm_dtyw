 ...
 * 各种筛选的adapter
 */
public class BrandAdapter extends HemaAdapter {
    private Context mContext;
    private ArrayList<Goods> goodses;
    public BrandAdapter(Context mContext,ArrayList<Goods> goodses) {
        super(mContext);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView==null)
        {
            ...
            convertView.setTag(R.id.TAG,hloder1);
        }
        ViewHloder1 hloder1 = (ViewHloder1) convertView.getTag(R.id.TAG);
