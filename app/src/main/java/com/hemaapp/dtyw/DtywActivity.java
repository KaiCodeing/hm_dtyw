...
import com.hemaapp.dtyw.view.DtywProgressDoalog;
import com.hemaapp.dtyw.view.DtywTextDialog;
 ...
 */
public abstract class DtywActivity extends HemaActivity{

    DtywTextDialog textDialog;
    DtywProgressDoalog progressDoalog;
    @Override
    ...
    public void showProgressDialog(String text) {
        if (progressDoalog == null)
            progressDoalog = new DtywProgressDoalog(this);
    ...
    public void showTextDialog(String text) {
        if (textDialog == null)
            textDialog = new DtywTextDialog(this);
