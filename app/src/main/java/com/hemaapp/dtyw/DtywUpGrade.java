 ...
 */
public class DtywUpGrade extends XtomObject {
    ...
    public DtywUpGrade(Context mContext) {
        this.mContext = mContext;
        this.netWorker = new DtywNetWorker(mContext);
    ...
    private boolean isMust() {
        SysInitInfo sysInfo = DtywApplication.getInstance().getSysInitInfo();
        boolean must = "1".equals(sysInfo.getAndroid_must_update());
        return must;
    }

    private class TaskExecuteListener extends DtywNetTaskExecuteListener {
