...
public class DtywImageWay extends XtomObject {
	...
	public DtywImageWay(Activity mContext, int albumRequestCode,
	...
	public DtywImageWay(Fragment mFragment, int albumRequestCode,
						int cameraRequestCode) {
