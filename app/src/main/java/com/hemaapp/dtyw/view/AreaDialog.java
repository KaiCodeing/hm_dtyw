...
import com.hemaapp.dtyw.wheel.adapter.ArrayWheelAdapter;
import com.hemaapp.dtyw.wheel.widget.OnWheelChangedListener;
import com.hemaapp.dtyw.wheel.widget.WheelView;
...
public class AreaDialog extends XtomObject implements OnWheelChangedListener {
	...
	private void initProvinceDatas() {
		city = DtywApplication.getInstance().getCityInfo();
